...
const Home = () => {
    ...
    const getData = () => {
        //Tracks Data
        axios.get('https://ed-4649021457301504.educative.run:3000/top-tracks')
        .then(res => {
        ...
        //Albums Data
        axios.get('https://ed-4649021457301504.educative.run:3000/top-albums')
        .then(res => {
        ...
        //Artist Data
        axios.get('https://ed-4649021457301504.educative.run:3000/top-artists')
        .then(res => {
        ...
        //Playlist Data
        axios.get('https://ed-4649021457301504.educative.run:3000/top-playlists')
        .then(res => {
        ...
        //Podcast Data
        axios.get('https://ed-4649021457301504.educative.run:3000/top-podcasts')
        .then(res => {
